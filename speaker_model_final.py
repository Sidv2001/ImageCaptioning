...
class Speaker_Model(torch.nn.Module):
    def __init__(self, referent, lstm, embedding, device):
...
class Speaker:
    ...
    def __init__(self, param_args):
        ...
        self.network = Speaker_Model(param_args.referent, param_args.speaker_lstm, param_args.embedding, self.device).to(self.device)
